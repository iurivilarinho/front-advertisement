...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={mergeClasses("[&_svg:not([class*='size-'])]:size-4", className)}
      {...props}
    >
      {children}
...
function ComboboxInput({
  ...
  return (
    <InputGroup className={mergeClasses("w-auto", className)}>
...
function ComboboxLabel({ className, ...props }: ComboboxPrimitive.GroupLabel.Props) {
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={mergeClasses("text-muted-foreground px-2 py-1.5 text-xs", className)}
      {...props}
    />
  );
}
...
function ComboboxChipsInput({ className, ...props }: ComboboxPrimitive.Input.Props) {
  return (
    <ComboboxPrimitive.Input
      ...
      className={mergeClasses("min-w-16 flex-1 outline-none", className)}
      {...props}
    />
  );
}
...
function ComboboxPositioner({ className, ...props }: ComboboxPrimitive.Positioner.Props) {
  return (
    <ComboboxPrimitive.Positioner
      ...
      className={mergeClasses("isolate z-50", className)}
      {...props}
    />
  );
}
